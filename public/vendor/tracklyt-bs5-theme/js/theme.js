...
(function() {
  ...
  const TracklytTheme = {
    ...
    initSidebar: function() {
      // Pattern 1: #sidebarToggle → #wrapper.toggled (used by app and admin layouts)
      const wrapperToggle = document.getElementById('sidebarToggle');
      const wrapper = document.getElementById('wrapper');

      if (wrapperToggle && wrapper) {
        wrapperToggle.addEventListener('click', function(e) {
          e.preventDefault();
          wrapper.classList.toggle('toggled');
        });
      }

      // Pattern 2: [data-sidebar-toggle] → .sidebar.active (theme sidebar component)
    ...
    // NOTE: Bootstrap 5 handles all data-bs-toggle="dropdown" elements natively.
    // A custom implementation here would double-fire and cause dropdowns to
    // open and immediately close on every click. No custom code needed.
    initDropdowns: function() {
      // intentionally empty — Bootstrap 5 manages dropdowns via data-bs-toggle
    },
